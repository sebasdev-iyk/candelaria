...
class DatabaseService {
    ...
    public function buildContext($userMessage) {
        ...
        $isAskingAboutServices = $this->containsKeywords($messageLower, ['servicio', 'hotel', 'hospedaje', 'hostal', 'restaurante', 'comida', 'comer', 'dormir', 'alojamiento', 'transporte']);
    ...
    private function getHotelDetails($id) {
        try {
            ...
            if ($row) {
                ...
                if ($price) $text .= "Precio: desde S/. {$price}\n";
                if ($desc) $text .= "Descripción: " . substr($desc, 0, 150) . "...\n";
    ...
    private function getNews() {
        ...
        if (empty($news)) {
            $news[] = "Visita la <a href='noticias/index.php' style='color: #fbbf24; text-decoration: underline;'>sección de Noticias</a> en nuestro sitio web para las últimas actualizaciones.";
        }
