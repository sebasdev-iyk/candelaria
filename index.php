...
<body>
  ...
  <!-- Chatbot Widget Structure (Candelaria Video Bot) -->
  ...
  <link rel="stylesheet" href="chatbot/style.css?v=<?php echo time(); ?>">
  <script src="chatbot/script.js?v=<?php echo time(); ?>"></script>
</body>
